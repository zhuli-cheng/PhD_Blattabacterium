...
source("ManuscriptBlattabacteriumLoss/Main.R")
source("ManuscriptBlattabacteriumLoss/KEGGtable.R")
source("ManuscriptBlattabacteriumLoss/OmegaMain.R")
source("ManuscriptBlattabacteriumLoss/HeatmapFunction.R")
...
kegg.pathway <- function(pathway.description) {
  ...
  png(paste0("/Users/zhulicheng/Desktop/BlattabacteriumRScripts/OrthologsAnalyses/", sample.size, "/output/KEGG_pathways_manuscript_Blattabacterium_Loss/", pathway.description, ".png") , width = 1200, height = 1600)
